...
const INITIAL_COMMANDES: Commande[] = [
  ...
  },
  {
    ...
    statut: 'livree',
    articles: [
      { id: '1', productName: 'Farine de Blé', unitPrice: 35.00, quantity: 10 },
      { id: '2', productName: "Huile d'Arachide", unitPrice: 42.00, quantity: 15 },
    ],
    totalHT: 980.00,
    tva: 176.40,
    totalTTC: 1156.40,
  ...
  },
  {
    ...
    statut: 'preparation',
    articles: [
      { id: '1', productName: 'Prestation Logistique & Transit', unitPrice: 7458.75, quantity: 1 },
    ],
    totalHT: 7458.75,
    tva: 1491.75,
    totalTTC: 8950.50,
  ...
  },
  {
    ...
    statut: 'livree',
    articles: [
      { id: '1', productName: 'Fournitures de bureau & consommables', unitPrice: 175.00, quantity: 10 },
    ],
    totalHT: 1750.00,
    tva: 350.00,
    totalTTC: 2100.00,
    notes: 'Commande livrée et réglée.',
  },
];
...
const FACTURE_COMMANDE_MAPPING: Record<string, string> = {
  'FAC-2026-0038': 'CMD-2026-0047',
  'FAC-2026-0039': 'CMD-2026-0048',
  'FAC-2026-0040': 'CMD-2026-0050',
  'FAC-2026-0041': '-',
  'FAC-2026-0042': 'CMD-2026-0052',
  'FAC-2026-0043': 'CMD-2026-0055',
  'FAC-2026-0044': 'CMD-2026-0056',
  'FAC-2026-0144': 'CMD-2026-0051',
};

function mapDbFacture(row: any): Facture {
  const num = row.numero || '';
  const fallbackCmd = FACTURE_COMMANDE_MAPPING[num] || undefined;
  return {
    id: row.id,
    numero: num,
    commandeId: row.commande_id || undefined,
    commandeNumero: row.commande_numero || fallbackCmd,
    clientId: row.client_id || '',
    clientNom: row.client_nom || '',
    clientEmail: row.client_email || '',
